      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
            Innovative solutions leveraging AI, IoT, and cutting-edge
            technologies
          </p>
        </div>
              ...
              return (
                <div
                  ...
                  className="
                    ...
                    hover:-translate-y-2 border border-slate-200
                  "
                >
                  {/* Top Color Line */}
                  <div
                  ...
                  <div className="p-6">
                    ...
                    {/* Tech */}
                    <p className={`text-sm ${colors.text} font-semibold mb-4`}>
                      {project.tech}
                    </p>
                    ...
                    <ul className="space-y-2 mb-6">
                      {project.description.map((item, idx) => (
                        ...
                        >
                          <span
                            className={`${colors.text} mr-2 mt-1 flex-shrink-0 text-xs`}
                          >
                            ▪
                          </span>
                          <span>{item}</span>
