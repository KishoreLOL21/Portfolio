...
const skillLogos: Record<string, IconType> = {
  ...
  "Google Cloud Platform": GooglecloudPlain,
  Git: GitPlain,
};
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill) => {
                    ...
                    return (
                      <span
                        key={skill}
                        className={`${colors.badge} inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium transition-transform hover:scale-105`}
                      >
                        {Logo && (
                          <Logo
                            size={18}
